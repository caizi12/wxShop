...
public class HttpsRequest implements IServiceRequest{
    ...
    private static  Logger log=Logger.getLogger(BaseDaoTemplate.class);
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream instream = new FileInputStream(new File(PayConstant.certLocalPath));//加载本地的证书进行https加密传输
        try {
            keyStore.load(instream, PayConstant.certPassword.toCharArray());//设置证书密码
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore,PayConstant.certPassword.toCharArray())
                .build();
    ...
    public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        try {
            ...
            log.info("executing request result:\n"+result);
    ...
    public String sendPost(String url, String jsonStr) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
